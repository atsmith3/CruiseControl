...
#ifndef __convolution5_fcmpfYi__HH__
#define __convolution5_fcmpfYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(convolution5_fcmpfYi) {
    ...
    SC_CTOR(convolution5_fcmpfYi):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
