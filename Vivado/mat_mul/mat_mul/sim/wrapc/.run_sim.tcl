...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "mat_mul_wrap.autotvin.dat"
	set constFileTvOut       "mat_mul_wrap.autotvout.dat"
	set constFileHdlTvIn     "mat_mul_wrap.autohdltvin.dat"
	set constFileHdlTvOut    "mat_mul_wrap.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
