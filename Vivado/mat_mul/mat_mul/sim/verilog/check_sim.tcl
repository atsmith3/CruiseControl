...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.mat_mul_wrap.autotvin_matA.dat"
         "c.mat_mul_wrap.autotvin_matB.dat"
         "c.mat_mul_wrap.autotvin_matC.dat"
         "c.mat_mul_wrap.autotvout_matC.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.mat_mul_wrap.autotvout_matC.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
