...
if {[file isfile mat_mul_wrap.autotvin.dat]} {
	file delete -force mat_mul_wrap.autotvin.dat
}

if {[file isfile mat_mul_wrap.autotvout.dat]} {
	file delete -force mat_mul_wrap.autotvout.dat
}
