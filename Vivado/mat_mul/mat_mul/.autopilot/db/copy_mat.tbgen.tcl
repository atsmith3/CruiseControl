...
set C_modelName {copy_mat}
set C_modelType { void 0 }
set C_modelArgList {
	{ src float 32 regular {array 10000 { 1 3 } 1 1 }  }
	{ dest float 32 regular {array 10000 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "src", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "dest", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ dest_address0 sc_out sc_lv 14 signal 1 } 
	{ dest_ce0 sc_out sc_logic 1 signal 1 } 
	{ dest_we0 sc_out sc_logic 1 signal 1 } 
	{ dest_d0 sc_out sc_lv 32 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "dest_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "dest", "role": "address0" }} , 
...
set PerformanceInfo {[
	...
	, {"Name" : "Interval", "Min" : "20201", "Max" : "20201"}
]}
...
set Spec2ImplPortList { 
	src { ap_memory {  { src_address0 mem_address 1 14 }  { src_ce0 mem_ce 1 1 }  { src_q0 mem_dout 0 32 } } }
	dest { ap_memory {  { dest_address0 mem_address 1 14 }  { dest_ce0 mem_ce 1 1 }  { dest_we0 mem_we 1 1 }  { dest_d0 mem_din 1 32 } } }
}
