...
#ifndef __mat_mul_wrap_mac_cud__HH__
#define __mat_mul_wrap_mac_cud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(mat_mul_wrap_mac_cud) {
    ...
    SC_CTOR(mat_mul_wrap_mac_cud):  simcore_mac_0_U ("simcore_mac_0_U") {
